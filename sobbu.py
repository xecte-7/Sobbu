...
banner = r'''{0}{2}
  .▄▄ ·       ▄▄▄▄· ▄▄▄▄· ▄• ▄▌ Cryptography tool with various encoding-decoding
  ▐█ ▀. ▪    ▐█ ▀█▪▐█ ▀█▪█▪██▌  and encryption algorithms {1}(v1.2){2}
  ▄▀▀▀█▄ ▄█▀▄ ▐█▀▀█▄▐█▀▀█▄█▌▐█▌
  ▐█▄▪▐█▐█▌.▐▌██▄▪▐███▄▪▐█▐█▄█▌ Coded by {3}Muhammad Rizky [Dr-3AM]{2}
   ▀▀▀▀  ▀█▄▀▪·▀▀▀▀ ·▀▀▀▀  ▀▀▀ 
{2}{0}'''.format(cl_reset, clfg_y, clfg_w, clfg_r, cl_bold)

list_mode = '''{0}  {1}[{3}01{1}] {2}Encode
  {1}[{3}02{1}] {2}Decode{0}'''.format(cl_reset, clfg_lg, clfg_y, clfg_w)

list_alg1 = '''{0}  {1}[{3}01{1}] {2}Base32       {1}[{3}07{1}] {2}SHA-1       {1}[{3}12{1}] {2}SHA3-224
...
list_alg2 = '''{0}  {1}[{3}01{1}] {2}Base32
  {1}[{3}02{1}] {2}Base64
  {1}[{3}03{1}] {2}Binary
  {1}[{3}04{1}] {2}Hex
  {1}[{3}05{1}] {2}Ascii-Text
  {1}[{3}06{1}] {2}URL Encode
{0}'''.format(cl_reset, clfg_lg, clfg_y, clfg_w)
def jeda():
